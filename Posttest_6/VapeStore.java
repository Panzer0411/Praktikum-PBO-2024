...
class VapeStore implements ProductManagement {
    private final ArrayList<AbstractProduct> products = new ArrayList<>();
    private static final Scanner scanner = new Scanner(System.in);
    private static int currentId = 1; // Menambahkan variabel currentId
